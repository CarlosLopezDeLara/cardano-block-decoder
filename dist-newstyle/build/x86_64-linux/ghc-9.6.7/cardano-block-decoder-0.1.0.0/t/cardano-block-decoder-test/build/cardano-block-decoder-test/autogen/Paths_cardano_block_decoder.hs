...
{-|
Module      : Paths_cardano_block_decoder
...
-- at runtime using the environment variable cardano_block_decoder_bindir.
...
-- environment variable cardano_block_decoder_libdir.
...
-- using the environment variable cardano_block_decoder_dynlibdir.
...
-- runtime using the environment variable cardano_block_decoder_datadir.
...
-- variable cardano_block_decoder_libexedir.
...
-- using the environment variable cardano_block_decoder_sysconfdir.
...
bindir     = "/home/carlos/.cabal/bin"
libdir     = "/home/carlos/.cabal/lib/x86_64-linux-ghc-9.6.7/cardano-block-decoder-0.1.0.0-inplace-cardano-block-decoder-test"
dynlibdir  = "/home/carlos/.cabal/lib/x86_64-linux-ghc-9.6.7"
datadir    = "/home/carlos/.cabal/share/x86_64-linux-ghc-9.6.7/cardano-block-decoder-0.1.0.0"
libexecdir = "/home/carlos/.cabal/libexec/x86_64-linux-ghc-9.6.7/cardano-block-decoder-0.1.0.0"
sysconfdir = "/home/carlos/.cabal/etc"

getBinDir     = catchIO (getEnv "cardano_block_decoder_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "cardano_block_decoder_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "cardano_block_decoder_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "cardano_block_decoder_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "cardano_block_decoder_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "cardano_block_decoder_sysconfdir") (\_ -> return sysconfdir)
